    ...
    <div id="gameScreen" class="screen">
      ...
      <div class="action-area">
        ...
        <div id="bankArea" style="display: none;">
          <button class="btn-success" onclick="bank()">🏦 Bank Now</button>
        </div>
      ...
      <div class="host-controls" id="hostControls" style="display: none;">
        <button class="btn-secondary" onclick="nextTurn()" id="nextTurnBtn">Next Turn →</button>
        <button class="btn-success" onclick="nextTurn()" id="nextRoundBtn" style="display: none;">Start Next Round →</button>
        <button class="btn-danger" onclick="undo()">↶ Undo</button>
      </div>
    </div>
